    ...
    <div class='flex flex-wrap items-center justify-between gap-4 w-full'>
      ...
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li class='max-lg:border-b max-lg:py-3 px-3'><a href='../view/BookingSlots.php'
              class='hover:text-[#007bff] text-[#333] block font-semibold text-[15px]'>Booking Appoinment</a>
          </li>
        </ul>
      </div>
  
      <div class='flex items-center ml-auto space-x-6'>
        <button class='font-semibold text-[15px] border-none outline-none'><a href='../view/Login.php'
